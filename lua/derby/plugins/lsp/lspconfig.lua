return {
	...
	config = function()
		-- FIX 1: Replace deprecated vim.lsp.set_log_level() with the 0.12+ API
		...
		local on_attach = function(client, bufnr)
			...
			keymap.set("n", "gD", function()
				-- FIX 2: Modern replacement for deprecated vim.lsp.buf_get_clients()
		...
		-- Native Neovim 0.11+ / 0.12 server declarations
		vim.lsp.config["ansiblels"] = { capabilities = capabilities, on_attach = on_attach }
		vim.lsp.config["clangd"] = {
			capabilities = capabilities,
			on_attach = on_attach,
			settings = { clangd = { format = { style = "file", tabSize = 4 } } },
		}
		...
		vim.lsp.config["docker_compose_language_service"] = { capabilities = capabilities, on_attach = on_attach }
		...
		vim.lsp.config["html"] = { capabilities = capabilities, on_attach = on_attach, filetypes = { "tmpl" } }
